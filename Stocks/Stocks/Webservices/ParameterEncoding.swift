...
public protocol ParameterEncoding {
    ...
    ///
    /// - throws: parameterEncodingFailed` error if encoding fails.
    ///
    ...
    public func encode(_ urlRequest: URLRequestConvertible, with parameters: Parameters?) throws -> URLRequest {
        ...
        if let method = HTTPMethod(rawValue: urlRequest.httpMethod ?? "GET"), encodesParametersInURL(with: method) {
            guard let url = urlRequest.url else {
                throw CEError.parameterEncodingFailed(reason: .missingURL)
            }
...
public struct JSONEncoding: ParameterEncoding {
    ...
    public func encode(_ urlRequest: URLRequestConvertible, with parameters: Parameters?) throws -> URLRequest {
        ...
        do {
            ...
            throw CEError.parameterEncodingFailed(reason: .jsonEncodingFailed(error: error))
        }
...
public struct PropertyListEncoding: ParameterEncoding {
    ...
    public func encode(_ urlRequest: URLRequestConvertible, with parameters: Parameters?) throws -> URLRequest {
        ...
        do {
            ...
            throw CEError.parameterEncodingFailed(reason: .propertyListEncodingFailed(error: error))
        }
